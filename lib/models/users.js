...
/**
 * instance method that determines whether a user has permission to perform a task based on their role
 * @param {string} task - the name of the desired task to perform
 * @returns {boolean} - true or false based on whether that task is listed in the acl under the user's role
 * @returns {Error} default - unexpected error
 */
